    ...
    def setup_routes(self):
        ...
        def status():
            return jsonify({
                ...
                'calibrated': True  # Always calibrated for face presence detection
            })
        ...
        def get_gaze_data():
            try:
                # Return simplified gaze data for face presence detection
                return jsonify({
        ...
        def get_enhanced_gaze():
            ...
            # Return simplified face detection result
            response_data = {
        ...
        def calibrate():
            try:
                # Face presence detection doesn't require calibration
        ...
        def get_session_metrics():
            try:
                # Return empty metrics for simplified face presence detection
                metrics = {}
